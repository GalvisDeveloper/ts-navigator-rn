...
const ROUTES = {
	[RouteTypes.Tab1]: 'emoji-emotions',
	[RouteTypes.Tab2]: 'question-answer',
	[RouteTypes.Stack]: 'switch-access-shortcut',
};
...
const TabIcons = (route: RouteProp<ParamListBase, string>, props: TabBarIconProps) => {
	...
	return <Icon name={ROUTES[iconName]} style={styles.icon} />;
};
...
const BottomTabsAndroid = () => {
	return (
		...
		>
			<TabAndroid.Screen name='Tab1' options={{ title: 'Icons' }} component={Tab1Screen} />
			<TabAndroid.Screen name='Tab2' options={{ title: 'Chats' }} component={TopTabsAndroid} />
...
const BottomTabsIOS = () => {
	return (
		...
		>
			<TabIos.Screen name='Tab1' options={{ title: 'Icons' }} component={Tab1Screen} />
			<TabIos.Screen name='Tab2' options={{ title: 'Chats' }} component={Tab2Screen} />
